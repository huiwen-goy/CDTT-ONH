...
## Power analysis
Currently, the mean SRT difference between YNH and ONH is 0.53914 dB. The variance of YNH is 0.4461181; the variance of ONH is 0.4670122.
...
If the number of participants in each group is 16 (what we have now), with an SRT difference of 0.2, the power is 0.63. In other words, with 16 participants per group, there isn't really enough power to detect a difference between groups of 0.2 dB.
...
2.256811 * (16 / 2)^0.5
# G*Power 3.1, post-hoc: delta = 6.3832254, power = 0.9999872
